      ...
      if (!isDispose) {
        ...
        if (_shopInfo != null && shopInfo.data != null) {
          ...
          replaceCheckoutEnable(
              ...
              _shopInfo.data.mercadopagoEnabled,
          ...
          replaceMercadopagoKey(_shopInfo.data.mercadopagoKey);

          replaceMercadopagoAccessToken(_shopInfo.data.mercadopagoAccessToken);

          replaceMercadopagoClientId(_shopInfo.data.mercadopagoClientId);

          replaceMercadopagoClientSecret(_shopInfo.data.mercadopagoClientSecret);

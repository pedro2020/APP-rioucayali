...
class PsProvider extends ChangeNotifier {
  ...
  Future<void> replaceMercadopagoKey(String pubKey) async {
    psRepository.replaceMercadopagoKey(pubKey);
  }

  Future<void> replaceMercadopagoAccessToken(String accessToken) async {
    psRepository.replaceMercadopagoAccesToken(accessToken);
  }

  Future<void> replaceMercadopagoClientId(String clientId) async {
    psRepository.replaceMercadopagoClientId(clientId);
  }

  Future<void> replaceMercadopagoClientSecret(String clientSecret) async {
    psRepository.replaceMercadopagoClientSecret(clientSecret);
  }
}

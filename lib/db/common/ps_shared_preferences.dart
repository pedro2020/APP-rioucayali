...
// Singleton instance
  ...
  void loadValueHolder() {
    ...
    final String _mercadopagoEnabled =
        shared.getString(PsConst.VALUE_HOLDER__MERCADOPAGO_ENABLED);
    ...
    final String _mercadopagoKey =
        shared.getString(PsConst.VALUE_HOLDER__MERCADOPAGO_KEY);

    final String _mercadopagoAccessToken =
    shared.getString(PsConst.VALUE_HOLDER__MERCADOPAGO_ACCESS_TOKEN);

    final String _mercadopagoClientId =
    shared.getString(PsConst.VALUE_HOLDER__MERCADOPAGO_CLIENT_ID);

    final String _mercadopagoClientSecret =
    shared.getString(PsConst.VALUE_HOLDER__MERCADOPAGO_CLIENT_SECRET);
    ...
    final PsValueHolder _valueHolder = PsValueHolder(
        ...
        mercadopagoKey: _mercadopagoKey,
        mercadopagoAccessToken: _mercadopagoAccessToken,
        mercadopagoClientId: _mercadopagoClientId,
        mercadopagoClientSecret: _mercadopagoClientSecret,
  ...
  Future<dynamic> replaceCheckoutEnable(
    ...
    await shared.setString(
        PsConst.VALUE_HOLDER__MERCADOPAGO_ENABLED, mercadopagoEnabled);
  ...
  Future<dynamic> replaceMercadopagoKey(String pubKey) async {
    await shared.setString(PsConst.VALUE_HOLDER__MERCADOPAGO_KEY, pubKey);

    loadValueHolder();
  }

  Future<dynamic> replaceMercadopagoAccessToken(String accessToken) async {
    await shared.setString(PsConst.VALUE_HOLDER__MERCADOPAGO_ACCESS_TOKEN, accessToken);

    loadValueHolder();
  }

  Future<dynamic> replaceMercadopagoClientId(String clientId) async {
    await shared.setString(PsConst.VALUE_HOLDER__MERCADOPAGO_CLIENT_ID, clientId);

    loadValueHolder();
  }

  Future<dynamic> replaceMercadopagoClientSecret(String clientSecret) async {
    await shared.setString(PsConst.VALUE_HOLDER__MERCADOPAGO_CLIENT_SECRET, clientSecret);

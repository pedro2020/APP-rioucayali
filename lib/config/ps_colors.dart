...
class PsColors {
  ...
  static const Color _c_main_dark_color = Color(0xff9e9e9e);
  ...
  static const Color _c_apple_login_color = Color(0xFFbdbdbd);
  ...
  static const Color _l_text_primary_color = Color(0xFF454545);
  static const Color _l_text_primary_light_color = Color(0xFFadadad);
  static const Color _l_text_primary_dark_color = Color(0x15505050);

  static const Color _l_icon_color = Color(0xFF454545);
  ...
  static void _loadDarkColors() {
    ...
    mainLightColorWithBlack = _d_base_color; ///aqui esta para cambiar los colores (aqui se ejecutan o compilan)
    ...
    ///de aqui para abajo se declaran
    ///
    /// Base Color
    ///

...
class PsConfig {
  ...
  ///
  static const String ps_api_key = 'gotlogic';
  ...
  static const String ps_app_url =
      'https://rioucayali.com/buenapesca/index.php/';

  static const String ps_app_image_url =
      'https://rioucayali.com/buenapesca/uploads/';

  static const String ps_app_image_thumbs_url =
      'https://rioucayali.com/buenapesca/uploads/thumbnail/';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  static final Language defaultLanguage =
      Language(languageCode: 'es', countryCode: 'ES', name: 'Spainish ES');

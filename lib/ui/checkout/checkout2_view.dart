    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _OrderSummeryTextWidget(
              transationInfoText:
                  '$currencySymbol ${double.parse(userProvider.user.data.area.price == '' ? '0.0' : userProvider.user.data.area.price)}',
              title: '${Utils.getString(context, 'checkout__shipping_cost')} :',
            ),
            _OrderSummeryTextWidget(
              transationInfoText:
                  '$currencySymbol ${Utils.calculateShippingTax(userProvider.user.data.area.price == '' ? '0.0' : userProvider.user.data.area.price, psValueHolder.shippingTaxValue == '' ? '0.0' : psValueHolder.shippingTaxValue)}',
              title:

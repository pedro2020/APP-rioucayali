...
class _Checkout3ViewState extends State<Checkout3View> {
  ...
  bool isMercadopagoClicked = false;
                      ...
                      return SingleChildScrollView(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Visibility(
                              //visible: shopInfoProvider.shopInfo.data.mercadopagoEnabled =='1',
                              visible: true,
                              child: Container(
                                width: PsDimens.space140,
                                height: PsDimens.space140,
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    if (!isMercadopagoClicked) {
                                      isCashClicked = false;
                                      isPaypalClicked = false;
                                      isStripeClicked = false;
                                      isMercadopagoClicked = true;
                                      isBankClicked = false;
                                      isRazorClicked = false;
                                    }
                                  ...
                                  child: checkIsMercadopagoSelected(),
                                ),
                              ),
                            ),
                            Visibility(
  ...
  Widget checkIsMercadopagoSelected() {
    if (!isMercadopagoClicked) {
      return changeMercadopagoCardToWhite();
    } else {
      return changeMercadopagoCardToOrange();
    }
  }

  Widget changeMercadopagoCardToWhite() {
    return Container(
      width: PsDimens.space140,
      child: Container(
        decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(Utils.getString(context, 'checkout3__mercadopago'),
                  style: Theme.of(context)
                      .textTheme
                      .subtitle1
                      .copyWith(height: 1.3)),
  ...
  Widget changeMercadopagoCardToOrange() {
    return Container(
      width: PsDimens.space140,
      child: Container(
        decoration: BoxDecoration(

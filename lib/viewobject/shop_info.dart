...
class ShopInfo extends PsObject<ShopInfo> {
  ShopInfo(
      ...
      this.mercadopagoClientId,
      this.mercadopagoClientSecret,
      this.currencySymbol,
  ...
  String mercadopagoKey;
  String mercadopagoAccessToken;
  String mercadopagoClientId;
  String mercadopagoClientSecret;
  ...
  ShopInfo fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return ShopInfo(
          ...
          mercadopagoKey: dynamicData['mercadopago_key'],
          mercadopagoAccessToken: dynamicData['mercadopago_access_token'],
          mercadopagoClientId: dynamicData['mercadopago_client_id'],
          mercadopagoClientSecret: dynamicData['mercadopago_client_secret'],
          ...
          mercadopagoEnabled: dynamicData['mercadopago_enabled'],
  ...
  Map<String, dynamic> toMap(dynamic object) {
    if (object != null) {
      ...
      data['mercadopago_key'] = object.mercadopagoKey;
      data['mercadopago_access_token'] = object.mercadopagoAccessToken;
      data['mercadopago_client_id'] = object.mercadopagoClientId;
      data['mercadopago_client_secret'] = object.mercadopagoClientSecret;
      ...
      data['mercadopago_enabled'] = object.mercadopagoEnabled;
